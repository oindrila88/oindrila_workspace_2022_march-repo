...
# MAGIC %md
# MAGIC # Perform Aggregate Operations on DataFrame in Databricks
...
# MAGIC %md
# MAGIC # What are Aggregate Functions?
...
df_ReadCustomerFileUsingCsv.select(count(col("c_first_name")), count("c_last_name")).show()
...
df_ReadCustomerFileUsingCsv.select(countDistinct(col("c_first_name")), countDistinct("c_last_name")).show()
