...
# MAGIC * <b>spark.conf.set("spark.databricks.cloudFiles.schemaInference.sampleSize.numBytes", "10gb")</b>. A "Byte String", like "10gb" can be Provided.
...
# MAGIC * <b>spark.conf.set("spark.databricks.cloudFiles.schemaInference.sampleSize.numFiles", 6)</b>. An "Integer" can be Provided.
