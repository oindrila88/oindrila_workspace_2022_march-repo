...
# MAGIC * Topic: How to Ingest the "Data" into an "Empty Delta Table"?
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS training.students;
# MAGIC 
# MAGIC 
# MAGIC CREATE TABLE IF NOT EXISTS training.students
# MAGIC (
...
# MAGIC %sql
# MAGIC SELECT * FROM training.students;
