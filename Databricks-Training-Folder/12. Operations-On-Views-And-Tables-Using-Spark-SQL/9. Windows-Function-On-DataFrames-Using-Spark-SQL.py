...
# MAGIC %md
# MAGIC # Use Window Functions on DataFrame Using Spark SQL in Databricks
...
# MAGIC * For the "<b>Row Number</b>" and "<b>Rank</b>" Function, it is required to additionally "<b>Order By</b>" on the "<b>Partition Data</b>" using the "<b>orderBy</b>" Function. This is the <b>Ordering Specification</b>.
...
# DBTITLE 1,Find the Second Expensive Item Bought by Each Customer
from pyspark.sql.window import Window
from pyspark.sql.functions import row_number, col

df_ProductCategory = spark.read\
                          .option("header", "true")\
                          .csv("/FileStore/tables/retailer/data/Product_Category.csv")

windowSpec = Window.partitionBy("CategoryType", "ProductType").orderBy(col("CostPrice").desc())

df_ProductCategoryWithRowNumber = df_ProductCategory\
                                                .withColumn("row_num", row_number().over(windowSpec))

display(df_ProductCategoryWithRowNumber)
...
# DBTITLE 1,Find the "Section" with the "Second Highest Scorer" in the "Entire Class"
from pyspark.sql.window import Window
