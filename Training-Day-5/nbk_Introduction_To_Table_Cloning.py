...
# MAGIC -- This "Shallow Cloned Delta Table" is "Stored" in the "Hive Metastore", Even Though Being "Created" From an "Unmanaged Delta Table".
...
# MAGIC -- This "Shallow Cloned Delta Table" is "Not Stored" in the "Hive Metastore", and, is also "Created" From an "Unmanaged Delta Table".
