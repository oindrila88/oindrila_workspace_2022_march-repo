...
# MAGIC %md
# MAGIC # Access DBFS of an "Azure Databricks Workspace" Using "Databricks CLI" from a "Local Machine"
# MAGIC * In the "Command Prompt", type the Utility Command "databricks fs ls" to Display "All" the Available "Directories" in the DBFS.
